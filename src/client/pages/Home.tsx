...
const cardCss = require('../sass/Card.scss');
...
export class CommunitiesCarousel extends React.Component {
    render() {
        return (
            <section id="communities-test" style={{ backgroundImage: "url('/assets/images/communities.jpg')" }}>
                <Translation>
                    { (t, i18n) => (
                        <ContentOpacityLayer>
                            <div className={css['content-side']}>
                                <Invite serverName="Terraria" iconURL="/assets/images/minecraft-icon.jpg" bgURL="/assets/images/minecraft.jpg" verified={true} status={{ members: 8200, online: 4500 }} />
                                <Invite serverName="Minecraft" iconURL="/assets/images/minecraft-icon.jpg" bgURL="/assets/images/minecraft.jpg" verified={true} status={{ members: 15000, online: 6000 }} />
                                <Invite serverName="Overwatch" iconURL="/assets/images/header.png" bgURL="/assets/images/communities.jpg" verified={true} status={{ members: 7000, online: 4000 }} />
                                <Invite serverName="AutoChess" iconURL="/assets/images/autochess-icon.jpg" bgURL="/assets/images/autochess.png" verified={true} status={{ members: 4500, online: 3100 }} />
                            </div>
                            <div className={css.hook}>
                                ...
                                <Link to="/pro" className={css.more}>Discover Servers</Link>
        ...
        return (
            <div>
                ...
                <main>
                    ...
                    <section id="lightweight" style={{backgroundImage: "url('/assets/images/lightweight.png')"}}>
                        <ContentOpacityLayer>
                            <div className={css.hook}>
