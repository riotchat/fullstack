...
class TestingSignUpForm extends React.Component<{url: string, emailName: string}, {email: string, submission: 0 | 1 | 2}> {
    ...
    render() {
        if(this.state.submission !== 2) {
            ...
            return <h4>Thank you for signing up to the Riot Tester team! We hope to see you soon.</h4>;
        }
    }
}
...
export const Home: React.FunctionComponent = () => (
    <div>
        ...
        <main>
                ...
                <div className={css.header}>
                    <div className={css['header-info']}>
                        <div className={css.text}>
                            ...
                            <h1 className={css.headerTitle} style={{fontSize: "55px"}}>Let's riot <span className={css.gradient}>together</span>.</h1>
            ...
            <section id="friends" style={{backgroundImage: "url('/assets/images/friends.png')"}}>
                <ContentOpacityLayer>
                    <div className={css.hook}>
                        ...
                        <h2>Find your friends easily.</h2>
            ...
            <section id="open-source" style={{background: 'linear-gradient(#667eea, #764ba2)'}}>
                <ContentOpacityLayer>
                    <div className={css.hook}>
                        <img
            ...
            <section id="pro" style={{background: 'linear-gradient(#9987F5, #EA86F3)'}}>
                <Content>
                    <div className={css.hook}>
                        ...
                        <h3>Take your riot to the next level.</h3>
