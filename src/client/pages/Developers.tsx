    ...
    <div>
        <Route exact path="/developers" render={() => (
            <div>
                <ScrollToTopOnMount />
                <main>
                    <header style={{ backgroundImage: 'url("/assets/images/developers.png")' }}>
                        <Navigation fixed={true} />
                        <div className={css.header}>
                            <div className={css['header-info']}>
                                <div className={css.text}>
                                    <h2 style={{ fontSize: "16px" }}>Welcome to the</h2>
                                    <h1 style={{ fontSize: "40px", marginBottom: "5px", fontFamily: "'Source Code Pro', monospace" }}>Developer Portal</h1>
                                ...
                                <div className={css.buttons}>
                                    <Link href="/developers/applications" className={css['btn-purple']}>Open Developer Portal</Link>
                                    <Link to="/developers/documentation" className={css['button']}>Documentation</Link>
                                </div>
                            </div>
                        </div>
                    </header>
                    <section id="github" style={{ background: "linear-gradient(-20deg, white, lightgrey)" }}>
                        <ContentOpacityLayer>
                            <div className={css.hook}>
                                ...
                                <a href="https://github.com/riotchat" className={css['btn-purple']}>View on GitHub</a>
                            </div>
                    ...
                    <section id="docs" style={{ background: "linear-gradient(-20deg, #B990F0, #3A319C)" }}>
                        <Content>
                            <div className={css.hook}>
                                <img src="data:image/png;base64," />
